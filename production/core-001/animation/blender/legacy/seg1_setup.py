...
output_dir = r"D:\Data Ratu\WEB PROJECT FOR BUSSINESS\Series Untuk Mahasiswa\00. Hasil animasi\\"
...
def set_visibility(visible_names):
...
def render_sequence(prefix, visible_names):
    set_visibility(visible_names)
    scene.render.filepath = output_dir + prefix
...
render_sequence("seg1_s1_", s1_names)
render_sequence("seg1_s3_", s3_names)

print("Scene ready: SEG1 base assets created and sequences rendered.")
